...
function Header() {
    const { user } = useUser();// Get the user object from the useUser hook
    const itemCount = useBasketStore((state) => state.items.reduce((total, item) =>
    total + item.quantity, 0));

    const createClerkPasskey = async () => {
        try {
            const response = await createClerkPasskey();
            ...
            <div className="flex w-full flex-wrap justify-between items-center">
                ...
                >
                    <input
                        ...
                        px-4 py-2 rounded focus:outline-blue-500
                        focus:ring-blue-500 focus:ring-opacity-50
                         border-2 w-full max-w-4xl"
                    />
                </Form>
                ...
                flex-1 sm:flex-none">
                    <Link
                        ...
                        space-x-2 bg-blue-500 hover:bg-blue-800 
                    ...
                    <ClerkLoaded>
                        ...
                        {user?.passkeys.length === 0 && (
                            ...
                            animate-pulse text-blue-500 font-bold py-2 px-4
                            rounded border-blue-300 border">
                                Create Passkey
                            </button>
                        )}
                    </ClerkLoaded>
