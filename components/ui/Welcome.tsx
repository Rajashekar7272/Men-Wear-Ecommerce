...
async function Welcome() {
    const sale = await getActiveSaleByCouponCode(COUPON_CODES.WELCOME)
  ...
  return (
    <div className="bg-gradient-to-r from-red-600 via-blue-500 to-green-400 text-white px-6 py-10
