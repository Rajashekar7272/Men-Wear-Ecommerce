...
import { getMyOrders } from "@/sanity/schemaTypes/orders/getMyOrders";
          ...
          <div className="space-y-6 sm:space-y-8">
            {orders.data.map((order) => (
              <div 
                ...
                className="bg-white border border-gray-900 rounded-lg shadow-sm overflow-hidden"
              >
                <div className="p-4 sm:p-6 border-b border-gray-400">
                  <div className="flex flex-col gap-4 sm:flex-row sm:justify-center sm:items-center mb-4">
                    <p className="text-sm text-gray-600 mb-1 font-bold">
                      Order Number:
                    </p>
                    <p className="font-mono text-green-500 text-sm break-all">
                      {order.orderNumber}
                    </p>
                  </div>
                  ...
                  {order.amountDiscount ? (
                    <div className="mt-4 p-3 sm:p-4 rounded-lg bg-gray-300">
                ...
                {/* Ordered Items Section - Moved below the currency and discount */}
