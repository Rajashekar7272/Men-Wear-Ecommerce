...
// Source: ./sanity/sales/getActiveSaleByCouponCode.ts
// Variable: ACTIVE_SALE_QUERY
// Query: *[        _type == "sale" && isActive == true        && couponCode == $couponCode &&        (validUntil > now() || !defined(validUntil))      ] | order(validFrom desc)[0]
...
// Source: ./sanity/schemaTypes/orders/getMyOrders.tsx
